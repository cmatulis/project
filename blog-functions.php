...
print <<<EOT
                  <p><a href="toBlog.php$likinguser">$likinguser</a> liked this </p>
EOT;
}
print <<<EOT
                  </div>
...
print <<<EOT
              <div class="blog-post">
                <h2 class="blog-post-title">$title</h2>
                <p class="blog-post-meta">$time by <a href="toBlog.php$user">$user</a></p>
        <p> <img src='$image'></p>
                <p> $entry </p> 
EOT;
...
print <<<EOT
    <div class="blog-post">
                <p class="blog-post-meta"><a href="http://cs.wellesley.edu/~cmatulis/project/toBlog.php$follower">$follower</a></p>
                <hr>
    </div>   
EOT;
   }
...
print <<<EOT
            ...
            <div class="blog-post">
                <p class="blog-post-meta"><a href="http://cs.wellesley.edu/~cmatulis/project/toBlog.php$following">$following</a></p>
                <hr>
    </div>    
EOT;
   }
